...
public class FreeMarkerTest {
	...
	public void testFreeMarker() throws Exception {
		...
		//3、设置模板文件保存的目录
		configuration.setDirectoryForTemplateLoading(new File("H:/workspaces-itcast5/e3-item-web/src/main/webapp/WEB-INF/ftl"));
		//4、模板文件的编码格式，一般就是utf-8
		configuration.setDefaultEncoding("utf-8");
		//5、加载一个模板文件，创建一个简单的模板对象。
		...
		//表示把模板文件中的占位符的值hellooo,替换为hellooo freemarker!
		data.put("hellooo", "hellooo freemarker!");
	...
	//	Writer out = new FileWriter(new File("C:/temp/JavaEE32/freemarker/hello.txt"));
		Writer out = new FileWriter(new File("C:/temp/JavaEE32/freemarker/student.html"));
		//8、生成静态页面
